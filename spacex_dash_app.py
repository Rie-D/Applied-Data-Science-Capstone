...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(
                                    ...
                                    options=[
                                        ...
                                        {'label': 'CVAFB SLC-4E', 'value': 'CVAFB SLC-4E'},
                                        {'label': 'KSC LC-39A', 'value': 'KSC LC-39'},
...
def scatter(site_dropdown, slider_range):
    ...
    if site_dropdown == 'All':
        ...
        scatter_fig=px.scatter(df_scatter, x='Payload Mass (kg)', y='class', color='Booster Version Category',title=title_scatter)
        return scatter_fig
    else:
        ...
        scatter_fig=px.scatter(filtered_scatter, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=title_scatter)
        return scatter_fig
